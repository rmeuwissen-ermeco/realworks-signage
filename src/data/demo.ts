export type StreamConfig = {
  ...
  logoUrl?: string; // later: upload per klant
};

export type SignageItem = {
  id: string;
  status: "Actief" | "Onder bod" | "Verkocht";
  addressLine: string;
  city: string;
  priceLine: string;
  features: string[]; // "120 m²", "5 kamers", "Energielabel A"
  imageUrl?: string;
  updatedAtISO: string;
};

export const demoStreams: Record<string, StreamConfig> = {
  demo: {
    streamKey: "demo",
...
export const demoItems: Record<string, SignageItem[]> = {
  demo: [
    {
      id: "RW-0001",
      status: "Actief",
